...
import com.kosta.service.UserServiceImplBJM;

/**
 * Handles requests for the application home page.
 */
@Controller
@RequestMapping(value = "/bjm", method = RequestMethod.GET)
public class BjmController {
	
	@Autowired
	private UserServiceImplBJM service;
	
	private static final Logger logger = LoggerFactory.getLogger(BjmController.class);
